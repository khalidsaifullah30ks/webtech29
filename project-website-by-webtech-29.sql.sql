...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2026 at 11:23 AM
...
--
-- Database: `project website by webtech 29`
--
...
CREATE TABLE `admins` (
  ...
  `Role` enum('editor','manager') NOT NULL DEFAULT 'manager',
...
INSERT INTO `admins` (`AdminID`, `Username`, `PasswordHash`, `Role`, `CreatedAt`) VALUES
(1, 'admin', '$2y$10$5umcnDuw/sb2m50nf7.lDu5yf8vSp6ocDp8FYnV.P4Wbm5MDOJR.a', 'manager', '2026-03-28 10:11:18');
...
(1, 1, 'John Doe', 'john.doe@example.com', '2026-03-28 09:44:36', 1),
(2, 4, 'Jane Smith', 'jane.smith@example.com', '2026-03-28 09:44:36', 1),
(3, 6, 'Alex Brown', 'alex.brown@example.com', '2026-03-28 09:44:36', 1),
(4, 9, 'Priya Patel', 'priya.patel@example.com', '2026-03-28 09:44:36', 1),
(5, 1, 'azmain ovy', 'azmainovy85@gmail.com', '2026-03-28 10:17:20', 1),
(6, 5, 'hossain ovy', 'azmainovy69@gmail.com', '2026-03-28 10:18:23', 1),
(7, 6, 'typ shi', 'azmainovy33@gmail.com', '2026-03-28 10:19:36', 0);
...
(1, 'BSc Computer Science', 1, 1, 'A broad computer science degree covering programming, AI, cybersecurity, and software engineering.', 'CSE1.jpg', 1),
(2, 'BSc Software Engineering', 1, 2, 'A specialized degree focusing on the development and lifecycle of software applications.', 'SE1.jpg', 1),
(3, 'BSc Artificial Intelligence', 1, 3, 'Focuses on machine learning, deep learning, and AI applications.', 'A1.jpg', 1),
(4, 'BSc Cyber Security', 1, 4, 'Explores network security, ethical hacking, and digital forensics.', 'CS1.jpg', 1),
(5, 'BSc Data Science', 1, 5, 'Covers big data, machine learning, and statistical computing.', 'DS1.jpg', 1),
(6, 'MSc Machine Learning', 2, 11, 'A postgraduate degree focusing on deep learning, AI ethics, and neural networks.', 'ML1.jpg', 1),
(7, 'MSc Cyber Security', 2, 12, 'A specialized programme covering digital forensics, cyber threat intelligence, and security policy.', 'CS2.jpg', 1),
(8, 'MSc Data Science', 2, 13, 'Focuses on big data analytics, cloud computing, and AI-driven insights.', 'DS2.jpg', 1),
(9, 'MSc Artificial Intelligence', 2, 14, 'Explores autonomous systems, AI ethics, and deep learning technologies.', 'A2.jpg', 1),
(10, 'MSc Software Engineering', 2, 15, 'Emphasizes software design, blockchain applications, and cutting-edge methodologies.', 'SE2.jpg', 1);
